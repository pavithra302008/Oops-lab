...
public class ArrayListExample {
     public static void main(String[] args) {
        ...
        obj1.add("Steve");
        obj1.add("Anuj");                
        System.out.println("\nCurrently the Array List obj1 has the following elements:"+obj1);
        obj1.add("Babu");
        obj1.add("Kamal");
        ...
        obj1.remove("Harry");
        System.out.println("\nCurrent ArrayList obj1 after removing elements:"+obj1);
        obj1.remove(1);
        System.out.println("\nCurrent array list of obj1 after removing the element index is:"+obj1);
        ...
        if (obj3.size() > 0) 
        {
            System.out.println("\nArrayList obj1 contains strings starting with given"+search+":" + obj3);
        } 
        else 
        {
